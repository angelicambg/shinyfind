...
summarize_over_group <- function (data_summarized_over_time, group = NULL) {
  ...
  data_summarized_over_group <-
    ...
    summarize(
      ...
      cap_cum_cases          = mean(cap_cum_cases, na.rm = TRUE),
      all_cum_deaths         = sum(all_cum_deaths, na.rm = TRUE),
      cap_cum_deaths         = mean(cap_cum_deaths, na.rm = TRUE),
      all_cum_tests          = sum(all_cum_tests, na.rm = TRUE),
      cap_cum_tests          = mean(cap_cum_tests, na.rm = TRUE),
      cap100k_cum_cases      = mean(cap100k_cum_cases, na.rm = TRUE),
      cap100k_cum_deaths     = mean(cap100k_cum_deaths, na.rm = TRUE),
      cap100k_cum_tests      = mean(cap100k_cum_tests, na.rm = TRUE),
